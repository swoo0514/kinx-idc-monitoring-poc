...
- **다른 대시보드의 패널을 보여 줄 때만 panel_image 에 scope="search" 를 적고, dashboard 에 그 대시보드 제목의 일부를 넣는다.** 그냥 부르면 사람이 보고 있는 패널을 그린다. 못 찾으면 결과에 대시보드 목록이 실려 온다. **그 목록을 보지 않고 "그런 패널은 없다" 고 단정하지 마라.**
