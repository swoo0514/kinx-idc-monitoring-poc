...
- **"3개 소스 연동"의 명확한 의미** — 3개 관측 시스템을 **통합 조회**한다는 의미이며, 3개 시스템의 알림이 반드시 하나의 사건으로 **병합**되는 것은 아닙니다. 정확한 개념은 **"2개 소스가 사건을 생성하고, 3개 소스가 사건을 종합 설명한다"** 입니다 ([`03-pitfalls/structural-gaps.md#g4`](03-pitfalls/structural-gaps.md#g4) 참조).
