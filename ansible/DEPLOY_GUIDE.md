...
ansible-playbook -i inventory.local.ini -e @lab_vars.yml msp_report.yml

# 2) 집계 드라이런 — 숫자와 요약 초안을 눈으로 본다
cd ~/kinx-idc-monitoring-poc/bot && python msp_report.py --host-filter customer-a
